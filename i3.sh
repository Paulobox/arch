...
# Install a window manager (i3) and its utilities
echo "Installing i3 and its utilities..."
arch-chroot /mnt pacman -S --noconfirm i3 dmenu

# Create a basic .xinitrc file to start i3
...
echo "Your system is installed. It took $elapsed_minutes minutes and $elapsed_seconds seconds to install Arch Linux + X + I3(window manager) **[once logged in type: startx]**. Press enter to reboot."
read empty
# Reboot system
reboot
